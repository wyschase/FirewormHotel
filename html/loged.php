...
<head>
    ...
    <link rel="shortcut icon" href="../images/LOGO-label.ico">
...
<div class="index-header">
    <div class="index-header-banner" id="header-banner">
        <div class="loading"><img src="../js/mf-pattern/img/loading.gif" alt="图片加载中..."></div>
        <div class="pic">
            <ul>
                <li><img src="../images/search01.jpg"></li>
                <li><img src="../images/search02.jpg"></li>
                <li><img src="../images/search03.jpg"></li>
                <li><img src="../images/search04.jpg"></li>
            </ul>
        </div>
        <div class="index-header-cover"></div>
        <div class="index-header-nav">
            <a href=""><img class="logo" src="../images/logo-2.png"></a>
            <a href="login.html" class="login">注销</a>
...
<div class="index-display-panel box">
    <div class="big-title"><img src="../images/当季热门.png" alt="当季热门"></div>
    <div class="sub-title">
        <ul>
...
<div class="index-sub-banner">
    ...
    <div class="index-sub-banner-text box">
        <img src="../images/特别推出莹家夏日度假村.png">
    </div>
